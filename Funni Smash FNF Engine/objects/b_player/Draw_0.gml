...
draw_char_sprite_ext(d_sprite,char,state,img_current,scfx,scfy,(facing = DIR.RIGHT ? (spr_facing = DIR.RIGHT ? 1 : -1) : (spr_facing = DIR.LEFT ? 1 : -1)),1,image_blend,image_alpha,SPRITE_ORIGIN.CENTER_MIDDLE)